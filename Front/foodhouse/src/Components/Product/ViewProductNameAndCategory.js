...
const ViewProductsCategoryAndName = () => {
  ...
  useEffect(() => {
    async function fetchProductsHandler() {
        const response = await fetch(
            "https://localhost:44326/Product/GetAllProductsWithNameAndCategory/" +
            name +
            "/" +
            category,
            {
        ...
        const products = data.map(function (item) {
            ...
            //DODATI ZA RECENZIJE LOGIKU OVDEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
...
export default ViewProductsCategoryAndName;
